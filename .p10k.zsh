# Generated by Powerlevel10k configuration wizard on 2024-11-01 at 21:42 EDT.
...
() {
  ...
  # If directory is too long, shorten some if its segments to the shortest possible unique
  ...
  #   typeset -g POWERLEVEL9K_DIR_WORK_BACKGROUND=43
  ...
  #   typeset -g POWERLEVEL9K_DIR_WORK_NOT_WRITABLE_BACKGROUND=43
  ...
  #   typeset -g POWERLEVEL9K_DIR_WORK_NON_EXISTENT_BACKGROUND=43
